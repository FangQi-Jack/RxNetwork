package com.jackfangqi.rxnetworklib.utils;
...
/**
 * Created by Jack Fang on 2017/1/13, 11:30.
 * Project: RxNetwork
...
public class HttpsCerUtils {
    ...
    public static InputStream trustedCertificatesInputStream() {
        return new Buffer()
                .writeUtf8(Constants.HTTPS_CER_PUBLIC)
                .writeUtf8(Constants.HTTPS_CER_CHAIN)
                .inputStream();
    }
    ...
    public static X509TrustManager trustManagerForCertificates(InputStream in) throws GeneralSecurityException {
        ...
        char[] password = Constants.HTTPS_CER_KEY_STORE_PSW.toCharArray();
